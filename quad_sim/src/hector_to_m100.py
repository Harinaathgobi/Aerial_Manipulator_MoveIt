...
def init():
    ...
    rospy.init_node('hector_to_m100')
    ...
    rospy.Subscriber("m100/land", Empty, landing_callback)
    rospy.Subscriber("m100/takeoff", Empty, takeoff_callback)
    rospy.Subscriber("m100/reset", Empty, emergency_callback)
